...
from utils.core_utils_end2end import train

import torch
import pandas as pd
import numpy as np
from datasets.wsi_dali_h5 import get_train_val_test_loaders
...
def main(args):
    ...
    train_dataset, val_dataset, _ = get_train_val_test_loaders(
        data_dir=data_dir, splitter_path='/data3/CMCS/raw_data_20x/codipai_dataset_info_partial_train_valid.csv'.format(args.split_dir, temp_split),
...
args.csv_path = '/data3/CMCS/raw_data_20x/codipai_dataset_info_partial.csv'
